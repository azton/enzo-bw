...

{
  ...
  if (ComovingCoordinates) {
    ...
    // set internal values to the cosmology units
    GlobalMassUnits = (*DensityUnits)*(*LengthUnits)*(*LengthUnits)*(*LengthUnits);
    GlobalDensityUnits = *DensityUnits;
    GlobalTimeUnits = *TimeUnits;
    GlobalLengthUnits = *LengthUnits;
