...
#pragma omp parallel private(i) shared(size, field) default(none)
#else
#pragma omp parallel private(i) shared(size, field, BaryonField, OldBaryonField) default(none)
#endif
  {
...
#pragma omp parallel private(i) shared(size, field, AccelerationField, OldAccelerationField) default(none)
    {
