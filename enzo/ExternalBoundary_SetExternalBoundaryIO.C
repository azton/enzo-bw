...
//          bt_buffer[bindex] = 3;
          ...
          case BoundaryUndefined:
            break;
          default:
            fprintf(stderr, "IO BoundaryType %d not recognized (x-left).\n", btb);
	...
	for (k = 0; k < GridDims[2]; k++) {
	  ...
	  case BoundaryUndefined:
            break;
	  default:
	    fprintf(stderr, "BoundaryType %d not recognized (x-left).\n",
...
//          bt_buffer[bindex] = 3;
          ...
          case BoundaryUndefined:
            break;
          default:
            fprintf(stderr, "IO BoundaryType %d not recognized (x-right).\n", btb);
            fprintf(stderr, "field %"ISYM" dim %"ISYM" face %"ISYM" slab %"ISYM" bindex %"ISYM" btb %"ISYM"\n",
              field, dim, face, slabsize, bindex, bt_buffer[bindex]);
            return FAIL;
          }
	...
	for (k = 0; k < GridDims[2]; k++) {
	  ...
	  case BoundaryUndefined:
            break;
	  default:
	    fprintf(stderr, "BoundaryType %d not recognized (x-right).\n",
...
//          bt_buffer[bindex] = 3;
          ...
          case BoundaryUndefined:
            break;
          default:
            fprintf(stderr, "IO BoundaryType %d not recognized (y-left).\n", btb);
            fprintf(stderr, "field %"ISYM" dim %"ISYM" face %"ISYM" slab %"ISYM" bindex %"ISYM" btb %"ISYM"\n",
              field, dim, face, slabsize, bindex, bt_buffer[bindex]);
            return FAIL;
          }
	...
	for (k = 0; k < GridDims[2]; k++) {
	  ...
	  case BoundaryUndefined:
            break;
	  default:
	    fprintf(stderr, "BoundaryType %d not recognized (y-left).\n",
...
//          bt_buffer[bindex] = 3;
          ...
          case BoundaryUndefined:
            break;
          default:
            fprintf(stderr, "IO BoundaryType %d not recognized (y-right).\n", btb);
            fprintf(stderr, "field %"ISYM" dim %"ISYM" face %"ISYM" slab %"ISYM" bindex %"ISYM" btb %"ISYM"\n",
              field, dim, face, slabsize, bindex, bt_buffer[bindex]);
            return FAIL;
          }
	...
	for (k = 0; k < GridDims[2]; k++) {
	  ...
	  case BoundaryUndefined:
            break;
	  default:
	    fprintf(stderr, "BoundaryType %d not recognized (y-right).\n",
...
//          bt_buffer[bindex] = 3;
          ...
          case BoundaryUndefined:
            break;
          default:
            fprintf(stderr, "IO BoundaryType %d not recognized (z-left).\n", btb);
            fprintf(stderr, "field %"ISYM" dim %"ISYM" face %"ISYM" slab %"ISYM" bindex %"ISYM" btb %"ISYM"\n",
              field, dim, face, slabsize, bindex, bt_buffer[bindex]);
            return FAIL;
          }
	...
	for (j = 0; j < GridDims[1]; j++) {
	  ...
	  case BoundaryUndefined:
            break;
	  default:
	    fprintf(stderr, "BoundaryType %d not recognized (z-left).\n",
...
//          bt_buffer[bindex] = 3;
          ...
          case BoundaryUndefined:
            break;
          default:
            fprintf(stderr, "IO BoundaryType %d not recognized (z-right).\n", btb);
            fprintf(stderr, "field %"ISYM" dim %"ISYM" face %"ISYM" slab %"ISYM" bindex %"ISYM" btb %"ISYM"\n",
              field, dim, face, slabsize, bindex, bt_buffer[bindex]);
            return FAIL;
          }
	...
	for (j = 0; j < GridDims[1]; j++) {
	  ...
	  case BoundaryUndefined:
            break;
	  default:
	    fprintf(stderr, "BoundaryType %d not recognized (z-right).\n",
