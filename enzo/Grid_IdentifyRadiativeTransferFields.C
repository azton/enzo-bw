					  ...
					  int &kdissH2INum) 
{
  ...
  if (RadiativeTransfer) {
    ...
    if (kphHINum<0 || gammaNum<0 || kphHeINum<0 || kphHeIINum<0 || kdissH2INum<0) {
      fprintf(stderr,"Could not identify a RadiativeTransferField!  kphHI=%"ISYM", gamma=%"ISYM", kphHeI=%"ISYM", kphHeII=%"ISYM", kdissH2I=%"ISYM"\n", kphHINum, gammaNum, kphHeINum, kphHeIINum, kdissH2INum);
      return FAIL;
    }
  }
